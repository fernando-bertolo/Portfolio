        ...
        <SectionConteudo>
          <DivProjeto>
            ...
            <DivInteriorDescricao>
              <Descricao>
                Este projeto será o trabalho de conclusão de curso da uma minha
                gradução na Faculdade Integrada Einstein de Limeira - FIEL, onde
                estou tendo a oportunidade de aprofundar meus conhecimentos em
                ReactJS com estilização CSS no Frontend, e no BackEnd, NodeJS
                com a biblioteca Express.
              </Descricao>
            </DivInteriorDescricao>
          </DivProjeto>
          ...
          <DivRepositorioGit>
            <DivBotaoGitHub>
              <GitHubPortfolio
                href="https://github.com/fernando-bertolo/Projeto-TCC"
                target="_blank"
              >
                GitHub
              </GitHubPortfolio>
